...
public class MultiNewsArticleDataModel implements Parcelable {

    public static final Creator<MultiNewsArticleDataModel> CREATOR = new Creator<MultiNewsArticleDataModel>() {
        @Override
        public MultiNewsArticleDataModel createFromParcel(Parcel in) {
            return new MultiNewsArticleDataModel(in);
        }

        @Override
        public MultiNewsArticleDataModel[] newArray(int size) {
            return new MultiNewsArticleDataModel[size];
        }
    };
    /**
    ...
    public MultiNewsArticleDataModel() {
    }
    protected MultiNewsArticleDataModel(Parcel in) {
...
//        has_m3u8_video = in.readByte() != 0;
    ...
    public boolean equals(Object o) {
        ...
        MultiNewsArticleDataModel that = (MultiNewsArticleDataModel) o;
...
//    }
    ...
    public String toString() {
        return "MultiNewsArticleDataModel{" +
                "log_pb=" + log_pb +
